...
Some metrics are available by age or gender. Click on the arrows in the table rows to see these details where available.

Metrics for specific industries are available on the Environment and Social tabs. Note that data is not available for ever metric on every industry.
...
The Environmental Metrics by Industry table presents select metrics for benchmarking for the available industries.

Click on the industry of choice to expand and see what metrics are available for that industry.

To see the values of a specific metric across multiple industries, click on the Expand/collapse all button to expand the full table. Use the industry and metric filters provided to restrict the table to the industries/metrics of interest.

To save the table data, use the Download table as CSV button.
...
The Social Metrics by Industry table presents select metrics for benchmarking for the available industries.

Click on the industry of choice to expand and see what metrics are available for that industry. Note that data is not available for ever metric on every industry.
...
::: {.card fill="false" title="Work absence of full-time employees"}
